...
//           Create a production order (auto-creates quote)
//         </Typography>
//       </Box>
...
//                     gutterBottom
//                   >
//                     <strong>Note:</strong> Creating this order will
//                     automatically:
//                   </Typography>
//                   <Typography
//                     variant="caption"
...
//                     display="block"
//                   >
//                     • Generate {formData.quantity} unit IDs
//                   </Typography>
//                   <Typography
//                     variant="caption"
//                     color="text.secondary"
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={8}>
            ...
            <FormCard>
              <SectionHeader>
                Order Essentials
                {/* <Person fontSize="small" /> Order Essentials */}
              </SectionHeader>
              <Stack spacing={4}>
                <Autocomplete
                  options={customers}
                ...
                {selectedProduct && (
                  ...
                  >
                    ...
                    <Typography variant="caption">
                      Code: {selectedProduct.productCode} • Base Price:{' '}
            ...
            <FormCard>
              <SectionHeader>
                Logistics & Schedule
                {/* <LocalShipping fontSize="small" /> Logistics & Schedule */}
              </SectionHeader>
            ...
            <FormCard sx={{ mb: 0 }}>
              <SectionHeader>
                Pricing & Payment
                {/* <AttachMoney fontSize="small" /> Pricing & Payment */}
              </SectionHeader>
              <Grid container spacing={4}>
                ...
                <Grid item xs={12}>
                  <TextField
                    ...
                    helperText="e.g. 50% Upfront, 50% on Delivery"
                  />
                </Grid>
              </Grid>
            </FormCard>
              ...
              >
                <Stack spacing={1}>
                  <Box sx={{ display: 'flex', gap: 1 }}>
                    ...
                    >
                      Generating <strong>{formData.quantity} unit IDs</strong>
                    </Typography>
                  </Box>
                  <Box sx={{ display: 'flex', gap: 1 }}>
                    <InfoOutlined
                    ...
                    <Typography
                      ...
                      sx={{ color: 'rgba(255,255,255,0.7)' }}
                    >
                      Creating linked <strong>Quote & Invoice</strong>
                    </Typography>
                  </Box>
                </Stack>
              </Box>
